...
/// enum, e.g. int32_t
enum class StructFields { char_t, int8_t, uint8_t, int16_t, uint16_t, int32_t, uint32_t, int64_t, uint64_t, float_t, double_t, string_t };
...
template <>
inline std::vector<char> convertIntToBlob<char>(const char val) {
    return {val};
}

template <>
inline std::vector<char> convertIntToBlob<int8_t>(const int8_t val) {
...
template <>
inline std::vector<char> convertIntToBlob<uint8_t>(const uint8_t val) {
...
template <>
inline std::vector<char> convertIntToBlob<int16_t>(const int16_t val) {
...
template <>
inline std::vector<char> convertIntToBlob<uint16_t>(const uint16_t val) {
...
template <>
inline std::vector<char> convertIntToBlob<int32_t>(const int32_t val) {
...
template <>
inline std::vector<char> convertIntToBlob<uint32_t>(const uint32_t val) {
...
template <>
inline std::vector<char> convertIntToBlob<int64_t>(const int64_t val) {
...
template <>
inline std::vector<char> convertIntToBlob<uint64_t>(const uint64_t val) {
